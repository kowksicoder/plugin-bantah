export declare const BANTAH_SKILL_VERSION = "1.0.0";
export declare const bantahSkillActionValues: readonly ["create_market", "join_yes", "join_no", "read_market", "check_balance"];
...
export type BantahSkillEnvelope = BantahSkillSuccessEnvelope | BantahSkillErrorEnvelope;
